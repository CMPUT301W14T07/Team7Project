...
public class ActionBarController {
	 ...
	 * <p>
	 * Sets the MenuItem, which is the button that was clicked on the action bar.
	 * 
	...
	/**
	 * Takes an item id and calls the associated method to provide button functionality.
	 * to the action bar.
	 * 
	 * @return Boolean representing whether a method has been called associated with button.
	 */
