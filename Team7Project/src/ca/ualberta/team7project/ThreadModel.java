...
public class ThreadModel
{
     ...
     * <p>
     * upVotes represents the number of times that a thread has been selected as
     * a favorite.
     * 
    ...
    /**
     * Returns the timestamp in a Date object when the thread was created or
     * last updated.
     * 
     ...
     *            Date object representing a timestamp.
     */
     ...
     * 
     * @param location
     *            , a Location objectd including longitude and latitude.
     */
     ...
     * <p>
     * Use care when calling this method as all threads are return in a single
     * linked list. The memory footprint can be quite large depending on the
     * number of associated child threads.
     * 
     ...
     * <p>
     * Threads are ordered chronologically. Other methods exist to sort a
     * thread.
     * 
     * @param thread
     *            , a ThreadModel object representing a child thread to the
     *            current thread.
     */
     ...
     * Therefore getLastThreadUniqueID() and setLastThreadUniqueID() must be
     * called from TopicModel whenever a new thread is created.
     * <p>
     * These methods must be called outside of ThreadModel, since the
     * ThreadModel does not have any knowledge of which topic it is associated
     * with.
     * 
     * @param uniqueID
     *            A generated unique ID from the the Topic the thread will be
     *            added to.
     */
     ...
     * 
     * @param authorName
     *            The given name of the thread author.
     */
