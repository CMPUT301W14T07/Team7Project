...
/**
 * Basic ElasticSearchOperation for posting TopicModel to server and pulling TopicModel from server 
 * Reference zjullion at https://github.com/zjullion/PicPosterComplete
 */
...
public class ElasticSearchOperation {
	...
	/**This method has big issue, not finished. it has to be checked line by line
	 * 
	 * @param searchTerm
	 * @param model
	 * @param activity
	 */
	public static void searchForPicPostModels(final String searchTerm, final TopicListModel model, 
