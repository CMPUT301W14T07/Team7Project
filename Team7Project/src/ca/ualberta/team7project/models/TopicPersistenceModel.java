...
/**
 * Class that provides methods for storing and loading from 
 * the ElasticSearch server and the disk
 * 
 */
public class TopicPersistenceModel
{
	 ...
	 * @param topicID the Elastic Search index genereted when the topic was created
	 ...
	 * <p>
	 * Checks if the topic's data has changed.
	 * If the topic has changed, returns the updated topic (the caller should save
	 * the updated topic to disk)
	 * <p>
	 * For now, this simply pulls the entire topic from server and compare.
	 * We may later add in a timestamp comparison before pulling to increase efficiency
	 ...
	 * <p>
	 * Should be called every time the data changes ie. <ul>
