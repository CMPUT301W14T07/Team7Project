...
public class TopicListModel
{
	 ...
	 * <p>
	 * Replaces the old topic object if it exists
	 * Otherwise simply adds the new topic to the list
	 * <p>
	 * This method should only be called to sync from disk or the server.
	 * This method should not be called <i>directly</i> to update
	 * 	the topic after the user writes a new comment
